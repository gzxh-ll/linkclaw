...
- [WebView2](https://developer.microsoft.com/en-us/microsoft-edge/webview2/)（打包后的安装包会自动下载/安装引导程序；开发环境如遇启动失败可手动安装）
...
# 离线安装 Node.js（可选）：将 node-*-x64.msi 放入 ./tool/，构建时会被打包进安装包
# 例如：tool/node-v22.11.0-x64.msi
